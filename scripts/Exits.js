...
async function main() {
    ...
    const executorMngr = await ExecutorMngr.deploy();
    ...
    const liquidityPoolMngr = await LiquidityPoolMngr.deploy(executorMngr.address , "0xF86B30C63E068dBB6bdDEa6fe76bf92F194Dc53c");
