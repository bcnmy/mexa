async function main() {
  ...
  let wethAddress = "0xa6fa4fb5f76172d178d61b04b0ecd319c5d1c0aa"; // mumbai
  ...
  tx = await lpProxy.addSupportedToken(wethAddress, "10000000000000000","100000000000000000000");
  receipt = await tx.wait(1);
  ...
  await lpProxy.setTokenTransferOverhead(wethAddress, 29766); //29766
  console.log("✅ USDT overhead added");
