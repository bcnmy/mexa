...
describe("Liquidity Pool Manager", function () {
    ...
    describe("Test Liqidity Pool manager methods", function () {
        ...
        it("Should fail to removeSupportedToken successfully: Only owner can remove supported tokens", async () => {
            await expect(
        ...
        it("Should updateTokenCap successfully", async () => {
            ...
            let newMinTokenCap = "200000000";
            let newMaxTokenCap = "20000000000";
        ...
        it("Should send ERC20 funds to user successfully", async () => {
          const dummyTxHash =
            "0xf408509b00caba5d37325ab33a92f6185c9b5f007a965dfbeff7b81ab1ec871a";
          await executorManager.addExecutor(owner, { from: owner });
          const usdtBalanceBefore = await USDT.balanceOf(liquidityPoolMngr.address);
          console.log(usdtBalanceBefore);
          liquidityPoolMngr.sendFundsToUser(
            USDT.address,
            "2000000",
            notOwner,
            dummyTxHash,
