...
contract UpgradeabilityProxy is Proxy {
   ...
   * This is the keccak-256 hash of "io.biconomy.dappgastank.implementation", and is
   * validated in the constructor.
   */
  bytes32 private constant IMPLEMENTATION_SLOT = 0xe2a172978cf771362dfe6f51bf505f0c9568df5ca40b9b66aebada76bc77fd4a;
  ...
  constructor(address _implementation) public {
    assert(IMPLEMENTATION_SLOT == keccak256("io.biconomy.dappgastank.implementation"));
...
contract AdminUpgradeabilityProxy is UpgradeabilityProxy {
   ...
   * This is the keccak-256 hash of "io.biconomy.dappgastank.admin", and is
   * validated in the constructor.
   */
  bytes32 private constant ADMIN_SLOT = 0x4a9693c4d9b5153004381c65773ec3024ec15dc910041dfaff193afb952faadb;
  ...
  constructor(address _implementation, address _admin) UpgradeabilityProxy(_implementation) public {
    ...
    assert(ADMIN_SLOT == keccak256("io.biconomy.dappgastank.admin"));
    _setAdmin(_admin);
  }
