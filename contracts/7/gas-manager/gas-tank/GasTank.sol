...
contract GasTank is Ownable {
    ...
    uint256 public minDeposit=1e18; // consider outstanding?
     ...
     */
    function depositFor(uint256 _fundingKey) public payable { //unix epoch time
    ...
    // mainatain depositors for funding key
