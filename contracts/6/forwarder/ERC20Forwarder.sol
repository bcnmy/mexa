 ...
 */
 contract ERC20Forwarder is ERC20ForwarderStorage,Ownable{
     ...
     * @param domainSeparator : the domain separator presented to the user when signing
     * @param sig : the signature generated by the user's wallet
     * @param permitOptions : the permit request options for executing permit 
     * @return success : false if call fails. true otherwise
     * @return ret : any return data from the call
     */
    ...
    **/
     ...
     * @return ret : any return data from the call
     */
    function permitAndExecutePersonalSign(
        ERC20ForwardRequest memory req,
        bytes calldata sig,
        PermitRequest memory permitOptions
        )
    ...
    **/
     ...
     * @return ret : any return data from the call
     */
    function permitEIP2612AndExecutePersonalSign(
        ERC20ForwardRequest memory req,
        bytes calldata sig,
        PermitRequest memory permitOptions
        )
    ...
    **/
     ...
     * @return ret : any return data from the call
     */
    function permitAndExecutePersonalSignWithGasTokens(
        ERC20ForwardRequest memory req,
        bytes calldata sig,
        uint256 gasTokensBurned,
        PermitRequest memory permitOptions
    ...
    **/
     ...
     * @return ret : any return data from the call
     */
    function permitEIP2612AndExecutePersonalSignWithGasTokens(
        ERC20ForwardRequest memory req,
        bytes calldata sig,
        uint256 gasTokensBurned,
        PermitRequest memory permitOptions
